    ...
    <div className="flex flex-col min-h-screen">
      ...
      <footer className="bg-gray-950 text-gray-300 mt-10">
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10 text-center md:text-left">
          {/* Brand */}
          <div>
            <h2 className="text-2xl font-bold text-white tracking-wide">PrepMate</h2>
            <p className="mt-3 text-sm text-gray-400 leading-relaxed">
              Your personalized interview revision companion.  
              <br /> Quick, smart & reliable.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 flex justify-center md:justify-start space-x-5">
              ...
              <a href="https://github.com/arunava2018" className="hover:text-yellow-400 transition-colors">
                <Github size={22} />
              </a>
              <a href="https://www.linkedin.com/in/arunava-banerjee1/" className="hover:text-yellow-400 transition-colors">
                <Linkedin size={22} />
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 py-5 text-center text-sm text-gray-500">
          <p>
            ...
            <span className="font-medium text-gray-300">PrepMate</span> • ©{" "}
